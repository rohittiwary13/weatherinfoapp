...
public class Current_observation{
   	...
   	private Number wind_gust_kph;
   	
   	private Number wind_gust_mph;
	...
	public void setWind_dir(String wind_dir){
 	...
 	public Number getWind_gust_kph(){
		return this.wind_gust_kph;
	}
	public void setWind_gust_kph(Number wind_gust_kph){
		this.wind_gust_kph = wind_gust_kph;
	}
 	public Number getWind_gust_mph(){
		return this.wind_gust_mph;
	}
	public void setWind_gust_mph(Number wind_gust_mph){
